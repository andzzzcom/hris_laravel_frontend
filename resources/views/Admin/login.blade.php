...
<head>
	...
	<link rel="icon" type="image/x-icon" href="{{ asset('assets/images/settings/'.$set['favicon_web'] ) }}"/>
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
						<img style="width:150px;height:auto;" src="{{asset('assets/images/settings/'.$set['logo_web'])}}"><br>
                        <br><p class="">Log in to your account to continue.</p>
                        ...
                        <form class="text-left" method="post" action="{{ url('admin/login') }}">
							...
							<div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="email" name="email" type="text" class="form-control" placeholder="enter your email here">
                                </div>

                                <div id="password-field" class="field-wrapper input mb-2">
                                    <div class="d-flex justify-content-between">
                                        <label for="password">PASSWORD</label>
                                        <a href="{{url('admin/forgot')}}" class="forgot-pass-link">Forgot Password?</a>
                                    </div>
