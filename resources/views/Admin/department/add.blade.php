@extends("Admin.incl.layout")
	...
	<div id="content" class="main-content">
		<div class="layout-px-spacing">
			...
			<form method="post" enctype="multipart/form-data" action="{{ url('admin/department/add') }}">
			@csrf
					...
					<div class="statbox widget box box-shadow">
						...
						@endif
							...
							<div class="input-group mb-3">
								...
								<input type="text" value="{{old('name')}}" class="form-control" required placeholder="Insert Department Name" name="name">
							</div>
