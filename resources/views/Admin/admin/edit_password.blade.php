						...
						<div class="widget-content widget-content-area">
							...
							<form method="post" enctype="multipart/form-data" action="{{ url('admin/admin/edit_password') }}">
								...
								<div class="input-group mb-3">
									...
									<input placeholder="Insert Old Password" required name="old_password" type="password" class="form-control" id="oldPassword">
								</div>
								...
								<div class="input-group mb-3">
									...
									<input type="password" class="form-control" name="new_password" id="newPassword" placeholder="Insert New Password">
								</div>
								...
								<div class="input-group mb-3">
									...
									<input type="password" class="form-control" name="new_password_confirm" id="newPassword2" placeholder="Insert New Password (Confirm)">
								</div>
