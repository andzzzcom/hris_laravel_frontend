							...
							<table id="multi-column-ordering" class="table table-hover" style="width:100%">
								...
								<tbody>
									...
									<tr>
										<td>{{ $i }}</td>
										<td>
											<img src="{{asset('assets/images/admin/'.$admin['avatar'])}}" style="width:50px;height:auto">
										</td>
										<td>
											{{ $admin['name'] }}<br>
										</td>
										...
										<td>
											<a title="edit" href="{{ url('admin/admin/edit/'.$admin['id_admin']) }}">
												<i class="fa fa-edit"></i>
											</a>
											<a title="delete" href="{{ url('admin/admin/delete/'.$admin['id_admin']) }}">
