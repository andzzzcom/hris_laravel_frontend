					...
					<div class="statbox widget box box-shadow">
						<div class="widget-header">                                
							<div class="row">
								<div class="col-xl-12 col-md-12 col-sm-12 col-12">
									<h4>Add Admin</h4>
									<h6>Default Password: 12345678</h6>    
								</div>                                                                    
							</div>
						</div>
						...
						@endif
							...
							<div class="input-group mb-3">
								...
								<input type="text" value="{{old('name')}}" class="form-control" required placeholder="Insert Admin Name" name="name">
							</div>
							...
							<div class="input-group mb-3">
								...
								<input type="email" value="{{old('email')}}" class="form-control" required placeholder="Insert Admin Email" name="email">
							</div>
							...
							<div class="input-group mb-3">
								...
								<input type="text" value="{{old('phone')}}" class="form-control" required placeholder="Insert Admin Phone" name="phone">
							</div>
							...
							<div class="input-group mb-3">
								...
								<input type="text" value="{{old('address')}}" class="form-control" required placeholder="Insert Admin Address" name="address">
							</div>
							...
							<div class="input-group mb-3">
								...
								<input type="text" value="{{old('born_place')}}" class="form-control" required placeholder="Insert Admin Born Place" name="born_place">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="statbox widget box box-shadow">
						<div class="widget-content widget-content-area">
							...
							<div class="input-group mb-3">
								...
								<input required name="avatar" type="file" class="form-control">
							</div>
