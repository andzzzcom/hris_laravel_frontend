@extends("Admin.incl.layout")
	...
	<div id="content" class="main-content">
		<div class="layout-px-spacing">
			...
			<form method="post" enctype="multipart/form-data" action="{{ url('admin/admin/delete') }}">
			@csrf
					...
					<div class="statbox widget box box-shadow">
						...
						@endif
							...
							<div class="input-group mb-3">
								...
								<input readonly type="text" value="{{$admin[0]['name']}}" class="form-control" required placeholder="Insert Admin Name" name="name">
							</div>
							...
							<div class="input-group mb-3">
								...
								<input readonly type="email" value="{{$admin[0]['email']}}" class="form-control" required placeholder="Insert Admin Email" name="email">
							</div>
							...
							<div class="input-group mb-3">
								...
								<input readonly type="text" value="{{$admin[0]['phone']}}" class="form-control" required placeholder="Insert Admin Phone" name="phone">
							</div>
							...
							<div class="input-group mb-3">
								...
								<input readonly type="text" value="{{$admin[0]['address']}}" class="form-control" required placeholder="Insert Admin Address" name="address">
							</div>
							...
							<div class="input-group mb-3">
								...
								<input readonly type="text" value="{{$admin[0]['born_place']}}" class="form-control" required placeholder="Insert Admin Born Place" name="born_place">
							</div>
						</div>
					</div>
				</div>
