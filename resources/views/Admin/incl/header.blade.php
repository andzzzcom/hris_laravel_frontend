            ...
            <ul class="navbar-item flex-row ml-auto">
                ...
                <li class="nav-item dropdown user-profile-dropdown  order-lg-0 order-1">
                    ...
                    <div class="dropdown-menu position-absolute e-animated e-fadeInUp" aria-labelledby="userProfileDropdown">
                        <div class="text-center user-profile-section">                            
                            <div class="media mx-auto">
								<div class="media-body">
									@if(!is_null(Session::get("avatar_admin")) && file_exists(('assets/images/admin/'.Session::get("avatar_admin"))))
										<img src="{{ asset('assets/images/admin/'.Session::get('avatar_admin')) }}" style="height:90px;width:auto" class="img-fluid mr-2 mt-10">
									@else
										<img src="{{ asset('assets/images/admin/admin.jpg') }}" style="height:90px;width:auto" class="img-fluid mr-2 mt-10">
									@endif
                                </div>
                            </div>                   
                            <div class="media mx-auto">
								<div class="media-body">
                                    <h5>{{ Session::get("username_admin") }}</h5>
                                    <p>{{ Session::get("email_admin") }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="dropdown-item">
                            <a href="{{ url('admin/admin/edit/'.Session::get('id_admin')) }}">
                        ...
                        <div class="dropdown-item">
                            <a href="{{ url('admin/admin/edit_password') }}">
