					...
					<div class="statbox widget box box-shadow">
						...
						<div class="widget-content widget-content-area">
							...
							<div class="input-group mb-3">
								...
								<input type="text" value="{{$employee[0]['name']}}" class="form-control" required placeholder="Insert Admin Name" name="name">
							</div>
							...
							<div class="input-group mb-3">
								...
								<input type="email" value="{{$employee[0]['email']}}" class="form-control" required placeholder="Insert Admin Email" name="email">
							</div>
							...
							<div class="input-group mb-3">
								...
								<input type="text" value="{{$employee[0]['phone']}}" class="form-control" required placeholder="Insert Admin Phone" name="phone">
							</div>
							...
							<div class="input-group mb-3">
								...
								<input type="text" value="{{$employee[0]['address']}}" class="form-control" required placeholder="Insert Admin Address" name="address">
							</div>
							...
							<div class="input-group mb-3">
								...
								<input value="{{$employee[0]['born_date']}}" id="basicFlatpickr" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Select Born Date" name="born_date">
							</div>
						</div>
					</div>
				</div>
