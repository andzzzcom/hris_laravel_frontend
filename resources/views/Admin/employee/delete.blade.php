@extends("Admin.incl.layout")
	...
	<div id="content" class="main-content">
		<div class="layout-px-spacing">
			...
			<form method="post" enctype="multipart/form-data" action="{{ url('admin/employee/delete') }}">
			@csrf
			<input type="hidden" name="id_employee" value="{{$employee[0]['id_employee']}}">
					...
					<div class="statbox widget box box-shadow">
						...
						<div class="widget-content widget-content-area">
							...
							<div class="input-group mb-3">
								...
								<input type="text" readonly value="{{$employee[0]['name']}}" class="form-control" required placeholder="Insert Admin Name" name="name">
							</div>
							...
							<div class="input-group mb-3">
								...
								<input type="email" readonly value="{{$employee[0]['email']}}" class="form-control" required placeholder="Insert Admin Email" name="email">
							</div>
							...
							<div class="input-group mb-3">
								...
								<input type="text" readonly value="{{$employee[0]['phone']}}" class="form-control" required placeholder="Insert Admin Phone" name="phone">
							</div>
							...
							<div class="input-group mb-3">
								...
								<input type="text" readonly value="{{$employee[0]['address']}}" class="form-control" required placeholder="Insert Admin Address" name="address">
							</div>
							
							<label for="bornDateAdmin">Born Date (Year - Month - Date
							)</label>
							<div class="input-group mb-3">
								<div class="input-group-prepend">
									<span class="input-group-text" id="basic-addon5"><i class="fa fa-calendar"></i></span>
								</div>
								<input readonly value="{{$employee[0]['born_date']}}" id="basicFlatpickr" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Select Born Date" name="born_date">
							</div>
						</div>
					</div>
				</div>
				<div id="flStackForm" class="col-lg-6 layout-spacing">
					<div class="statbox widget box box-shadow">
						<div class="widget-content widget-content-area">
							...
							<br>
							<img src="{{asset('assets/images/employee/'.$employee[0]['photo'])}}" style="width:120px;height:auto">
							<br>
							<br>
							<div class="input-group mb-3">
								<div class="input-group-prepend">
