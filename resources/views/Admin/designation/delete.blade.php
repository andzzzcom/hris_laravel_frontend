			...
			<nav class="breadcrumb-one layout-top-spacing" aria-label="breadcrumb">
				<ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
						<span>Remove Designation</span>
					</li>
				</ol>
			</nav>
			
			<form method="post" enctype="multipart/form-data" action="{{ url('admin/designation/delete') }}">
			@csrf
			<input type="hidden" name="id_designation" value="{{$designation[0]['id_designation']}}">
					...
					<div class="statbox widget box box-shadow">
						...
						@endif
							...
							<div class="input-group mb-3">
								...
								<input readonly type="text" value="{{$designation[0]['name']}}" class="form-control" required placeholder="Insert Designation Name" name="name">
							</div>

							<label for="departmentDesignation">Department</label>
							<div class="input-group mb-3">
								<div class="input-group-prepend">
									<span class="input-group-text" id="basic-addon5"><i class="fa fa-toggle-on"></i></span>
								</div>
								<select readonly name="id_department" class="form-control">
